...
There is an ORDER to which these creations
must be done.
  - first, create the quest. 
    Follow the directions at:          src/quest/README.txt

  - second, create the sql
    Follow the directions at:          src/sql/README.txt

  - third, create the perl
    Follow the directions at:          src/perl/README.txt
