...
def main():
    ...
    quest_name = sys.argv[1].strip()
    safe_name = quest_name.replace(" ", "_")
    script_dir = os.path.dirname(os.path.abspath(__file__))     # points to .../GPT/prompts
    gpt_root = os.path.abspath(os.path.join(script_dir, ".."))  # points to .../GPT
    BASE_PATH = os.path.join(gpt_root, "Eulogies", safe_name, "build", "quest")
    print(f"[DEBUG] BASE_PATH resolved to: {BASE_PATH}")
